...
make_rand_plot <- function(split_subgroups, return_what) {
  set.seed(42)
  grp1 <- noisy_line(input$mlow, 3.5, input$nlow, 'Low risk')
  grp2 <- noisy_line(input$mmed, 6.5, input$nmed, 'Medium risk')
  grp3 <- noisy_line(input$mhi, 0, input$nhi, 'High risk')
